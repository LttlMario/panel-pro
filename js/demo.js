const demoScreens = {
  ...
  craft: { title:'Craft Mechanics', subtitle:'Vezi aceeași galerie, căutare și previzualizare ca în modulul actual de mecanic.', tag:'INFORMAȚII DEMO', guide:['Ce găsești în Craft Mechanics','În varianta reală, cauți unelte, piese, jante sau echipamente și deschizi detaliile. Demo-ul păstrează galeria și zoom-ul, fără crafting sau consum de resurse.'], body:`<div class="screen-head"><div><p class="panel-eyebrow">GALERIE CRAFT MECHANICS</p><h2>Echipamente și obiecte</h2><p>16 elemente fictive din galeria modulului.</p></div><span class="screen-tag">DOAR INFORMAȚII</span></div><input id="gallery-search" class="demo-input" placeholder="Caută rețetă, unealtă sau jantă..."><div class="feature-layout info-six-grid"><div class="feature-box"><span class="info-index">01</span><h3>Echipamente</h3><p>Uneltele și echipamentele disponibile.</p></div><div class="feature-box"><span class="info-index">02</span><h3>Materiale</h3><p>Materiale necesare pentru operațiuni.</p></div><div class="feature-box"><span class="info-index">03</span><h3>Obiecte</h3><p>Obiectele urmărite în modulul mecanic.</p></div><div class="feature-box"><span class="info-index">04</span><h3>Timp de lucru</h3><p>Durata estimată pentru operațiuni.</p></div><div class="feature-box"><span class="info-index">05</span><h3>Stoc</h3><p>Cantitățile disponibile.</p></div><div class="feature-box"><span class="info-index">06</span><h3>Inventar</h3><p>Istoricul obiectelor în varianta reală.</p></div></div><div id="asset-gallery" class="asset-gallery"></div>` },
...
function initDemoShell() {
  ...
  if (demoNav) {
    demoNav.innerHTML = `<p class="nav-label">Operațiuni</p>
      ...
      <button class="demo-nav-item" data-demo="craft"><span class="nav-icon">⌁</span> Craft Mecanics</button>
      <p class="nav-label">Resurse ilegale</p>
      <button class="demo-nav-item" data-demo="calculator-ilegal"><span class="nav-icon">⊞</span> Calculator Ilegal</button>
