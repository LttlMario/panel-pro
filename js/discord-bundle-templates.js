(() => {
  ...
  const renderPreview = () => {
    ...
    const descriptions = { full: 'Toate rutele Panel Pro: legale, ilegale, management, Stash, pontaj, rapoarte săptămânale, remindere și Status Live.', legal_management: 'Rutele legale și de management: anunțuri, învoiri, pontaj, contracte, marketplace legal, acțiuni, rapoarte și Status Live.', illegal: 'Rutele ilegale și operaționale: marketplace ilegal, amenzi, avertismente, sancțiuni, acțiuni, Stash și Status Live.' };
