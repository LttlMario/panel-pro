(() => {
  ...
  window.saveDraftConfiguration = async ({ silent = false } = {}) => {
    if (!organizationId) throw new Error('Creează mai întâi organizația Draft.');
