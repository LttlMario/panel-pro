(() => {
  ...
  function init() {
    ...
    if (location.pathname.endsWith('creare-organizatie-voucher.html')) {
      ...
      const channelScript=document.createElement('script');channelScript.src='js/discord-channel-config.js?v=20260905-bulk-publish';document.head.appendChild(channelScript);
