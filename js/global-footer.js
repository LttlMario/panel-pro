(() => {
  ...
  function getReleaseVersion() {
    return window.PANEL_RELEASE?.version || "3.8.0";
  }
  ...
  function init() {
    ...
    if (location.pathname.endsWith('creare-organizatie-voucher.html')) {
      ...
      const draftScript=document.createElement('script');draftScript.src='js/draft-config-ui.js?v=3.9.0';document.head.appendChild(draftScript);
