(() => {
    ...
    const recipes = [
        ...
        { id: 'xenon_albastru', name: 'Xenon albastru', base: { Safir: 6, Plastic: 20, Cabluri: 4 } },
        { id: 'xenon_albastru_deschis', name: 'Xenon albastru deschis', base: { Safir: 4, Diamant: 2, Plastic: 20, Cabluri: 4 } },
        { id: 'xenon_verde', name: 'Xenon verde', base: { Emerald: 6, Plastic: 20, Cabluri: 4 } },
        { id: 'xenon_verde_deschis', name: 'Xenon verde deschis', base: { Emerald: 4, Diamant: 2, Plastic: 20, Cabluri: 4 } },
        { id: 'xenon_galben_deschis', name: 'Xenon galben deschis', base: { Rubin: 2, Emerald: 2, Diamant: 2, Plastic: 20, Cabluri: 4 } },
        { id: 'xenon_galben', name: 'Xenon galben', base: { Rubin: 4, Diamant: 2, Plastic: 20, Cabluri: 4 } },
        { id: 'xenon_portocaliu', name: 'Xenon portocaliu', base: { Rubin: 4, Diamant: 2, Plastic: 20, Cabluri: 4 } },
        { id: 'xenon_rosu', name: 'Xenon roșu', base: { Rubin: 6, Plastic: 20, Cabluri: 4 } },
        { id: 'xenon_roz_deschis', name: 'Xenon roz deschis', base: { Rubin: 2, Diamant: 4, Plastic: 20, Cabluri: 4 } },
        { id: 'xenon_roz', name: 'Xenon roz', base: { Rubin: 4, Diamant: 2, Plastic: 20, Cabluri: 4 } },
        { id: 'xenon_mov', name: 'Xenon mov', base: { Rubin: 4, Safir: 2, Plastic: 20, Cabluri: 4 } },
        { id: 'xenon_mov_deschis', name: 'Xenon mov deschis', base: { Rubin: 4, Safir: 2, Diamant: 2, Plastic: 20, Cabluri: 4 } },
