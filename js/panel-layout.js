...
(() => {
    ...
    if (window.location.pathname.endsWith('vouchere.html')) {
        const script = document.createElement('script'); script.src = 'js/voucher-admin-controls.js?v=3.13.0'; document.head.appendChild(script);
        const listScript = document.createElement('script'); listScript.src = 'js/voucher-list-controls.js?v=3.13.0'; document.head.appendChild(listScript);
        const enhancementScript = document.createElement('script'); enhancementScript.src = 'js/voucher-enhancements.js?v=3.13.0'; document.head.appendChild(enhancementScript);
    }
    if (window.location.pathname.endsWith('organizatii.html')) { const requestScript=document.createElement('script');requestScript.src='js/organization-request-fix.js?v=3.13.0';document.head.appendChild(requestScript); const script=document.createElement('script');script.src='js/package-limits.js?v=3.13.0';document.head.appendChild(script); }
    ...
    function normalizeNavigation(navigation, currentPage) {
        const sections = [
            ...
            ['administratie', 'Administrație', [
                ['prelungire-organizatie.html', '⏳', 'Prelungește organizația'],
                ['logs.html', '🧾', 'Loguri'],
