...
const bundles: Record<string, string[]> = {
  full: ['organization', 'departments', 'pontaj', 'weekly_reports', 'requests', 'requests_organization', 'requests_departments', 'contracts', 'contract_identity_weekly', 'calculator', 'illegal_calculator', 'marketplace', 'illegal_marketplace', 'illegal_locations', 'actions_organization', 'actions_organization_weekly', 'event_reminders', 'status_live', 'organization_expiration', 'stash', 'stash_requests', 'stash_donations', 'log_pontaj', 'log_requests_organization', 'log_requests_departments', 'log_announcements_organization', 'log_announcements_departments', 'log_contracts', 'log_contract_identity_weekly', 'log_actions_organization', 'log_marketplace', 'log_illegal_marketplace', 'log_event_reminders', 'log_stash', 'log_stash_requests', 'log_stash_donations', 'contract_uploads'],
  legal_management: ['organization', 'departments', 'pontaj', 'weekly_reports', 'requests', 'requests_organization', 'requests_departments', 'contracts', 'contract_identity_weekly', 'calculator', 'marketplace', 'actions_organization', 'actions_organization_weekly', 'event_reminders', 'status_live', 'organization_expiration', 'log_pontaj', 'log_requests_organization', 'log_requests_departments', 'log_announcements_organization', 'log_announcements_departments', 'log_contracts', 'log_actions_organization', 'log_marketplace', 'log_event_reminders', 'log_contract_identity_weekly', 'contract_uploads'],
  illegal: ['illegal_calculator', 'illegal_marketplace', 'illegal_locations', 'actions_organization', 'actions_organization_weekly', 'event_reminders', 'status_live', 'stash', 'stash_requests', 'stash_donations', 'organization_expiration', 'log_illegal_marketplace', 'log_actions_organization', 'log_event_reminders', 'log_stash', 'log_stash_requests', 'log_stash_donations', 'contract_uploads']
};
