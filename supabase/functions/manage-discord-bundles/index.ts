...
const routeLabels: Record<string, string> = {
  organization: 'Anunțuri organizație', departments: 'Anunțuri angajați', pontaj: 'Pontaj și ture', weekly_reports: 'Rapoarte săptămânale', requests: 'Cereri', requests_organization: 'Învoiri organizație', requests_departments: 'Învoiri angajați', contracts: 'Contracte', contract_identity_weekly: 'Raport săptămânal contracte', calculator: 'Calculator legal', illegal_calculator: 'Calculator ilegal', marketplace: 'Marketplace legal', illegal_marketplace: 'Marketplace ilegal', illegal_locations: 'Locații ilegale', fines_organization: 'Amenzi organizație', fines_departments: 'Amenzi angajați', warnings_organization: 'Avertismente organizație', warnings_departments: 'Avertismente angajați', sanctions_organization: 'Sancțiuni organizație', sanctions_departments: 'Sancțiuni angajați', actions_organization: 'Acțiuni organizație', actions_organization_weekly: 'Clasament acțiuni săptămânal', event_reminders: 'Evenimente și remindere', status_live: 'Status Live', organization_expiration: 'Expirare organizație', stash: 'Stash organizație', stash_requests: 'Cereri Stash', stash_donations: 'Donații Stash', log_pontaj: 'Log pontaj', log_requests_organization: 'Log învoiri organizație', log_requests_departments: 'Log învoiri angajați', log_announcements_organization: 'Log anunțuri organizație', log_announcements_departments: 'Log anunțuri angajați', log_contracts: 'Log contracte', log_discipline_organization: 'Log disciplină organizație', log_discipline_departments: 'Log disciplină angajați', log_stash: 'Log Stash', log_stash_requests: 'Log cereri Stash', log_stash_donations: 'Log donații Stash', log_actions_organization: 'Log acțiuni', log_marketplace: 'Log marketplace legal', log_illegal_marketplace: 'Log marketplace ilegal', log_event_reminders: 'Log evenimente', log_contract_identity_weekly: 'Log raport contracte', contract_uploads: 'Upload contracte'
};
// Preseturile noi folosesc canale consolidate: anunțurile includ disciplina,
// iar Stash include cereri și donații. Cheile vechi rămân recunoscute pentru
// compatibilitate cu organizațiile deja configurate, dar nu mai creează canale noi.
const bundles: Record<string, string[]> = {
  full: ['organization', 'departments', 'pontaj', 'weekly_reports', 'requests', 'requests_organization', 'requests_departments', 'contracts', 'contract_identity_weekly', 'calculator', 'illegal_calculator', 'marketplace', 'illegal_marketplace', 'illegal_locations', 'actions_organization', 'actions_organization_weekly', 'event_reminders', 'wheel_timer', 'status_live', 'organization_expiration', 'stash', 'stash_requests', 'stash_donations', 'log_pontaj', 'log_requests_organization', 'log_requests_departments', 'log_announcements_organization', 'log_announcements_departments', 'log_contracts', 'log_contract_identity_weekly', 'log_actions_organization', 'log_marketplace', 'log_illegal_marketplace', 'log_event_reminders', 'log_stash', 'log_stash_requests', 'log_stash_donations', 'contract_uploads'],
  legal_management: ['organization', 'departments', 'pontaj', 'weekly_reports', 'requests', 'requests_organization', 'requests_departments', 'contracts', 'contract_identity_weekly', 'calculator', 'marketplace', 'actions_organization', 'actions_organization_weekly', 'event_reminders', 'wheel_timer', 'status_live', 'organization_expiration', 'log_pontaj', 'log_requests_organization', 'log_requests_departments', 'log_announcements_organization', 'log_announcements_departments', 'log_contracts', 'log_actions_organization', 'log_marketplace', 'log_event_reminders', 'log_contract_identity_weekly', 'contract_uploads'],
  illegal: ['illegal_calculator', 'illegal_marketplace', 'illegal_locations', 'actions_organization', 'actions_organization_weekly', 'event_reminders', 'wheel_timer', 'status_live', 'stash', 'stash_requests', 'stash_donations', 'organization_expiration', 'log_illegal_marketplace', 'log_actions_organization', 'log_event_reminders', 'log_stash', 'log_stash_requests', 'log_stash_donations', 'contract_uploads']
};
bundles.operations = ['organization', 'requests_organization', 'actions_organization', 'illegal_marketplace', 'illegal_locations', 'log_announcements_organization', 'log_requests_organization', 'log_actions_organization', 'log_illegal_marketplace', 'wheel_timer'];
...
const definitions: Record<string, any> = {
  ...
  illegal_locations: { title: '🗺️ Locații ilegale · Panel Pro', description: 'Alege harta. Embedul se actualizează direct în Discord și păstrează butoanele pentru cele 3 zone.', color: 0xef4444, buttons: [['Los Santos', 4, 'panel:illegal_locations:map:ls'], ['Cayo Perico', 4, 'panel:illegal_locations:map:cayo'], ['Maldive', 4, 'panel:illegal_locations:map:maldive']] },
  ...
  calculator: { title: '🧮 Calculator legal · Panel Pro', description: 'Alege categoria, articolul și cantitatea pentru a calcula materialele directe și brute.', color: 0x22c55e, buttons: [['Începe calculul', 1, 'panel:calculator:legal:start']] },
  illegal_calculator: { title: '🚨 Calculator ilegal · Panel Pro', description: 'Calculează arme, muniție, topitorie și resurse ilegale direct din Discord.', color: 0xef4444, buttons: [['Începe calculul', 4, 'panel:calculator:illegal:start']] },
  wheel_timer: { title: '🎡 Roată · timer personal', description: 'Pornește timerul personal de 6 ore și verifică timpul rămas. Răspunsurile sunt private pentru fiecare utilizator.', color: 0x06b6d4, buttons: [['Am dat la roată', 1, 'panel:wheel:start'], ['Verifică timpul', 2, 'panel:wheel:status']] },
...
definitions.comenzi = { title: '📦 Comenzi ilegale', description: 'Trimite comenzi pe categorii și urmărește aprobarea lor în Panel Pro.', color: 0xf97316, buttons: [['Trimite comandă', 5, '', 'https://panel-pro.ro/comenzi.html'], ['Vezi comenzile', 5, '', 'https://panel-pro.ro/comenzi.html']] };
